            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        <h2>{{$categ->Category_Name}} Products</h2>
                        ...
                        <div class="thumb">
                            <div class="hover-content">
                                <ul>
                                    ...
                                    <li><a href="/single/{{$product->id}}"><i class="fa fa-shopping-cart"></i></a></li>
                                </ul>
                            </div>
                            <img src="{{ asset('uploads/products/' . $product->Image) }}" width="300" height="300" alt="">
                        </div>
