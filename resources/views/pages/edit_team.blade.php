                ...
                <form method="POST" action="/team/update/{{$team->id}}" enctype="multipart/form-data">
                  ...
                  @method('put')
                    <div class="form-group">
                      ...
                      <input type="text" value="{{$team->team_name}}" class="form-control" name="team_name" />
                    </div>
                    <div class="form-group">
                      <label for="name">Team Category: </label>
                      <input type="text" value="{{$team->team_category}}" class="form-control" name="team_category" />
                    </div>
                    <div class="form-group">
                        <label for="name">Number Of Members: </label>
                        <input type="number" value="{{$team->members_number}}" class="form-control" name="team_number" />
                    </div>
                    <div class="form-group">
                        <label for="name">Team Details: </label>
                        <input type="text" value="{{$team->team_detail}}" class="form-control" name="team_detail" />
                      </div>
